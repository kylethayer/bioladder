...
Ext.define('BioLadderOrg.view.AboutCladesPanel', {
    ...
    config: {
        ...
        items: [{
            ...
            html: [
                '<p>',
                    '<b>What are Parent and Child Clades?</b>',
                '</p><br>',
                '<p>',
                ...
                '</p><br>',
                '<p>',
                    'A Clade is a taxon consisting of an organism and all its descendants. ',
                ...
                '</p><br>',
                '<p>',
                    'BioLadder.org shows clades organized vertically so that each clade is shown as a ',
                    'child clade of its parent above.',
                '</p>'].join('')
        }],
        maxHeight: 600,
        maxWidth: 650,
